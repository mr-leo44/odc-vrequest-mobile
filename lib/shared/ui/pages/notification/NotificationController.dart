...
class NotificationController extends _$NotificationController {
  ...
  void listen(){
    state = state.copyWith(initialAction: initialAction);
  }
  ...
  static Future<void> onActionReceivedImplementationMethod(
      ReceivedAction receivedAction) async {
    MyApp.navigatorKey.currentState?.pushNamedAndRemoveUntil('/home/profil',
        (route) => (route.settings.name != "/home/profil") || route.isFirst,
  ...
  static Future<void> createNewNotification(
      NotificationPush notification) async {
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: notification.id, // -1 is replaced by a random number
        ...
        actionButtons: notification.notificationActionButtons);
  }
}
