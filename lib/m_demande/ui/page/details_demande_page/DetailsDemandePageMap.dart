...
class DetailsDemandePageMap extends ConsumerStatefulWidget {
  Demande? demande;
  DetailsDemandePageMap({required this.demande});

  @override
  ConsumerState<DetailsDemandePageMap> createState() => _ChatMapsState();
}

class _ChatMapsState extends ConsumerState<DetailsDemandePageMap>
        ...
        Row(
          ...
          children: [
            ...
            MaterialButton(
              onPressed: () {
                HapticFeedback.selectionClick();
                  print(widget.demande!.longitudelDestination);
